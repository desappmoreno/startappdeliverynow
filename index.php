			...
			if(isset($res->isbb) && $res->isbb){
				...
				if(isset($res->i_res)){
					...
					// case content
						...
						http_response_code($res->i_res->cus_res_code);

						// 定义Content-Type
						header('Content-Type: '.$res->i_res->cus_res_ctype);
